...
class IRListener (IRResource):
    ...
    http3_options: Dict[str, str] # options available when HTTP protocolStackElement is present, else ignored
    ...
    reuse_port: bool # indicates port sharting between socket_protocols is allowed (same saddress & port)
    ...
    def __str__(self) -> str:
        ...
        return f'<Listener {self.name} on {socket_protocol}://{self.bind_address}:{self.port} ' \
